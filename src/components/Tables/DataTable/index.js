  ...
  return (
    <Paper sx={{ width: '100%', overflow: 'hidden' }}>
      <FullScreen handle={handle} className={handle.active ? 'component' : ''}>
        <MDBox>
          <MDBox sx={{ position: 'sticky', top: 0, backgroundColor: '#fff' }}>
            {tableTitle ? (
              <MDBox
                display="flex"
              ...
              >
                ...
                <MDBox pr={3} pt={1}>
                  {handle.active ? (
                    ...
                    <FullscreenIcon onClick={handle.enter} fontSize="large" />
                  )}
                </MDBox>
              </MDBox>
            ) : (
                    ...
                    {tableType === 'userleadsTable' ? (
                      <MDBox mt={''} ml={2}>
                        ...
                        <Autocomplete
                          ...
                          onChange={
                            (event, newValue) => {
                              onUpdateDropdown(newValue,"AddColumn");
                            }
          ...
          <TableContainer
            sx={{
              boxShadow: 'none',
              height: handle.active ? '70vh' : '500px',
              overflow: data.length ? 'scroll' : 'hidden',
            }}
          >
            {isLoading ? (
              <MDBox textAlign="center" sx={{height:"100%",display:"flex",alignItems:"center",justifyContent:"center"}}>
                              ...
                              return (
                                ...
                                >
                                  ...
                                  {showDeleteIcon ? (
                                    <CloseIcon
                                      onClick={(e) => {
                                        onUpdateDropdown(column?.id,"DeleteColumn");
                                      }}
                                      fontSize="small"
                                    />
                                  ) : (
