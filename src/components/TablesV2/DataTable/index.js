          ...
          >
            ...
            >
              ...
              <Autocomplete
                ...
                onChange={(event, newValue) => {
                  handleSortingOrder(event, newValue);
                }}
                size="small"
                sx={{ width: '13vw' }}
                renderInput={(params) => (
              ...
              <Autocomplete
                disableClearable
                defaultValue={
                  leadsType === false ? 'Current clients' : 'Archived clients'
                }
                options={['Current clients', 'Archived clients']}
                onChange={(event, newValue) => {
                  handleArchivedLeads(event, newValue);
                }}
                size="small"
                sx={{ width: '13vw' }}
                renderInput={(params) => (
