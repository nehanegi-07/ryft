...
function ClientNoteOneForm({ handleCloseModal, value, leadId }) {
                ...
                <MDBox component="form" role="form" onSubmit={formik.handleSubmit}>
                    <MDBox mb={2}>
                        <MDInput
                            ...
                            variant="standard"
                            value={formik.values.clientNotes1}
                            id="clientNotes1"
                            autoComplete="clientNotes1"
                            onChange={formik.handleChange}
                            error={formik.touched.clientNotes1 && Boolean(formik.errors.clientNotes1)}
                            helperText={formik.touched.clientNotes1 && formik.errors.clientNotes1}
                            fullWidth
                        />
                    </MDBox>
...
export default ClientNoteOneForm;
