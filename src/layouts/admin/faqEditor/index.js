...
import { updateFaqContent } from "services/Admin.Services"
import { getFaqContent } from 'services/User.Services';
...
const EditorForFaq = () => {
  ...
  const content = draftToHtml(convertToRaw(editorState.getCurrentContent()))
   ...
   const { mutate } = useMutation(updateFaqContent, {
        onSuccess: (res) => {
            ...
            <MDBox  sx={{display:"flex",alignItems:"center",width:"100%",justifyContent:"center",pt:2,pb:2}} >
              <MDTypography display="inline" variant="h3" textTransform="capitalize" fontWeight="bold" >
                Preview
                  ...
                  <Card sx={{overflowY:"scroll",height: "500px", width:"100%", display: "flex", alignItems: "center", pt:4,borderRadius:0}}>
                    <MDBox
                  sx={{pl:4,pr:2,width:"95%",height:"90%"}}
